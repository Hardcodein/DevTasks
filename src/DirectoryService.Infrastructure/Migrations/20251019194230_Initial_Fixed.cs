        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fk_parent_departments = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_departments_departments_fk_parent_departments",
                        column: x => x.fk_parent_departments,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_departments_positions_positions_location_id",
                        column: x => x.location_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_departments_fk_parent_departments",
                table: "departments",
                column: "fk_parent_departments");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_departments_positions_location_id",
                table: "departments_positions",
                column: "location_id");
